...
class KidFinancials extends StatefulWidget {
  final Map<String, dynamic> kidDetails;
  KidFinancials(this.kidDetails);
  @override
  _KidFinancialsState createState() => _KidFinancialsState();
}

class _KidFinancialsState extends State<KidFinancials> {
  List financialsList = [];
  ...
  void getKidFinancials() async {
    ...
    await KidsAPi.getKidFinancials(
      ...
      setState(() {
        ...
        totalFinancialsCount = int.parse(value['count'].toString()) ?? 0;
      });
    ...
    return ReduxSelector<AppState, dynamic>(
        ...
        builder: (BuildContext context, _, AppState state, __, ___,
            ...
            StandardScreen(
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                        ...
                        child: StandardDropdownField(
                          ...
                          values:
                              years.map((key, value) => MapEntry(key, value)),
              ...
              title: " ماليات " + widget.kidDetails['level_name'],
