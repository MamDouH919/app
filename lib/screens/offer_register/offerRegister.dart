...
class OfferRegister extends StatefulWidget {
  final Map<String, dynamic> offerDetails;
  OfferRegister(this.offerDetails);
  @override
  _OfferRegisterState createState() => _OfferRegisterState();
}

class _OfferRegisterState extends State<OfferRegister> {
  ...
  void registerChild(BuildContext context) async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        //todo add user id
        await CoursesApi.registerNewKid(
            controllers,
            branch,
            applicationDate,
            availableTime,
            availableDate,
            widget.offerDetails['courseData']['id'].toString(),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            widget.offerDetails['courseData']
                                                        ['photo'] ==
                                                    "default"
                                                ? _baseUrl +
