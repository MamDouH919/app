...
class KidRouteAttendanceMonth extends StatefulWidget {
  final Map<String, dynamic> kidAttendanceMonth;
  KidRouteAttendanceMonth(this.kidAttendanceMonth);
  @override
  _KidRouteAttendanceMonthState createState() =>
      _KidRouteAttendanceMonthState();
}

class _KidRouteAttendanceMonthState extends State<KidRouteAttendanceMonth> {
  void initState() {
    super.initState();
  }
